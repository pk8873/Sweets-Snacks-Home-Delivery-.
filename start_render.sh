...
# V78/V79 verify that the repaired transport is actually present before startup.
...
log "WhatsApp runtime V61 + V62 + V63 + V64 + V67 + V68 + V69 + V70 + V71 + V72 + V73 + V76 + V77 + V78 + V79 enabled."
