...
node whatsapp_bot/prepare_pairing_v11.js || { log "ERROR: WhatsApp pairing V11 preparation failed."; exit 1; }
node whatsapp_bot/prepare_pairing_v12.js || { log "ERROR: WhatsApp pairing V12 preparation failed."; exit 1; }
node whatsapp_bot/prepare_pairing_v13.js || { log "ERROR: WhatsApp pairing V13 preparation failed."; exit 1; }
