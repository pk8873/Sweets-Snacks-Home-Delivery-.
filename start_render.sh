...
# DEPLOY_MARKER_2026_09_15: always deploy the current main branch so V67/V68/V69/V70/V71/V72/V73
...
# V73 is the final targeted interactive transport enforcement layer. It only
# replaces the WhatsApp buttons/list sender with zqbaileys_helper low-level
# native-flow relay and leaves every existing action ID and business handler unchanged.
