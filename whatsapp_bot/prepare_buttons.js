...
const marker = "WHATSAPP_BUTTON_FLOW_PATCH_V13";

if (source.includes(marker)) {
  console.log("WhatsApp button/function compatibility patch V13 already applied.");
  process.exit(0);
}
...
// Accept the current productActions signature whether it has a legacy `base`
// argument or not. This was the reason V12 stopped during Render startup.
replace(
...
console.log("WhatsApp button/function compatibility patch V13 applied.");
