...
const marker = "WHATSAPP_BUTTON_FLOW_PATCH_V11";

if (source.includes(marker)) {
  console.log("WhatsApp button/function compatibility patch V11 already applied.");
  process.exit(0);
}
...
console.log("WhatsApp button/function compatibility patch V11 applied.");
